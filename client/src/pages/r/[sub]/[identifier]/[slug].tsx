...
export default function PostPage() {
  ...
  return (
    <>
      ...
      <Link href={`/r/${sub}`}>
        <a>
          <div className="flex items-center w-full h-16 py-2 bg-white">
            <div className="container flex">
              ...
              <p className="text-lg font-bold text-gray-500">@{sub}</p>
            </div>
          </div>
        </a>
      </Link>
                    ...
                    <div>
                      <p className="mb-1 text-xs">
                        ...
                        <Link href={`/u/${user.username}`}>
                          <a className="font-semibold text-secondary-500">
                            {user.username}
                          </a>
                        </Link>
                      </p>
