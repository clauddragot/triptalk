      ...
      {sub && (
        <Fragment>
          ...
          <div>
            {/* Banner image */}
            <div
              className={classNames("bg-primary-300", {
                "cursor-pointer": ownSub, // if user is the owner of the sub, then cursor is activated
              })}
              onClick={() => openFileInput("banner")}
            >
              {sub.bannerUrl ? (
                <div
                  className="h-56 bg-primary-300"
                  style={{
                ...
                <div className="h-20 bg-white border-2 border-t-0 border-l-0 border-r-0 border-primary-300 border-opacity-80 border-doubled"></div>
              )}
            </div>
            {/* Sub meta data */}
